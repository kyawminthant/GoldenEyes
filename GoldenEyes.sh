...
echo ""
# Generate a random quote for daily motivation
# Array of Daily quotes
daily_quotes=("The only way to do great work is to love what you do. - Steve Jobs" "Security is always excessive until it's not enough. - Robbie Sinclair" "The greatest glory in living lies not in never falling, but in rising every time we fall. - Nelson Mandela" "The only limit to our realization of tomorrow will be our doubts of today. - Franklin D. Roosevelt" "Success is not final, failure is not fatal: It is the courage to continue that counts. - Winston Churchill")
# Get a random quote from the array
random_daily_quote=${daily_quotes[$RANDOM % ${#daily_quotes[@]}]}

# Print the quote
echo "QUOTE OF THE DAY: $random_daily_quote" | lolcat
sleep 1
...
tput bold;echo "CHECKING IF YOU ARE CONNECTED TO THE INTERNET OR NOT!" | lolcat
# Check connection
wget -q --spider https://google.com
if [ $? -ne 0 ];then
    echo "++++ CONNECT TO THE INTERNET BEFORE RUNNING GoldenEyes !" | lolcat
    exit 1
fi
tput bold;echo "++++ CONNECTION FOUND, LET'S GET STARTED!" | lolcat
...
mv urls.txt $domain
rm -rf lolcat
echo "Targets have been TERM7NATED... I'll be BACK soon!" | lolcat
